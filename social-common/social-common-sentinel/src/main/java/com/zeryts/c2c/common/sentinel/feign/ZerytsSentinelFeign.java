 ...
 * @date 2020/12/14
 */
public final class ZerytsSentinelFeign {

	private ZerytsSentinelFeign() {

	}

	public static ZerytsSentinelFeign.Builder builder() {
		return new ZerytsSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public ZerytsSentinelFeign.Builder contract(Contract contract) {
		...
		public Feign build() {
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					Object feignClientFactoryBean = ZerytsSentinelFeign.Builder.this.applicationContext
