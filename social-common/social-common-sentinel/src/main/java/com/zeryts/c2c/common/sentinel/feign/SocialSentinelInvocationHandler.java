 ...
 */
@Slf4j
public class SocialSentinelInvocationHandler implements InvocationHandler {
	...
	SocialSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			SocialSentinelInvocationHandler other = (SocialSentinelInvocationHandler) obj;
